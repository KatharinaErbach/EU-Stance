...
const eInsightsTarget = document.getElementById('insights-target')
const eInsightsStance = document.getElementById('insights-stance')
...
function loadTweet(tweetID) {
    ...
    embedTweet(tweetID)
     ...
     // display data
    displayTopic(tweetData.target, tweetData.label)
...
function displayTopic(target,stance) {
    var eAnchor

    eInsightsTarget.innerHTML = "Topic: "
    eAnchor = document.createElement('a')
    eAnchor.innerText = target
    eInsightsTarget.append(eAnchor)
    

    eInsightsStance.innerHTML = "Stance: "
    eAnchor = document.createElement('a')
    eAnchor.innerText = stance
    eInsightsStance.appendChild(eAnchor)
